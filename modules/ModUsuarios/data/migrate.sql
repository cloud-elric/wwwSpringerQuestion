...
-- Volcando estructura para tabla yii2basic.mod_usuarios_cat_status_sesiones
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_cat_status_sesiones: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla yii2basic.mod_usuarios_cat_status_usuarios
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_cat_status_usuarios: ~3 rows (aproximadamente)
...
-- Volcando estructura para tabla yii2basic.mod_usuarios_ent_sesiones
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_ent_sesiones: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `mod_usuarios_ent_sesiones` DISABLE KEYS */;
/*!40000 ALTER TABLE `mod_usuarios_ent_sesiones` ENABLE KEYS */;


-- Volcando estructura para tabla yii2basic.mod_usuarios_ent_usuarios
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_ent_usuarios: ~1 rows (aproximadamente)
/*!40000 ALTER TABLE `mod_usuarios_ent_usuarios` DISABLE KEYS */;
/*!40000 ALTER TABLE `mod_usuarios_ent_usuarios` ENABLE KEYS */;


-- Volcando estructura para tabla yii2basic.mod_usuarios_ent_usuarios_activacion
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_ent_usuarios_activacion: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla yii2basic.mod_usuarios_ent_usuarios_cambio_pass
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_ent_usuarios_cambio_pass: ~1 rows (aproximadamente)
...
-- Volcando estructura para tabla yii2basic.mod_usuarios_ent_usuarios_facebook
...
-- Volcando datos para la tabla yii2basic.mod_usuarios_ent_usuarios_facebook: ~0 rows (aproximadamente)
